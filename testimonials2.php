			...
			<h5>Here you can find stories posted by vapers about how vaping has affected them.</h5>
				<div class="row">
					<div class="large-9 columns">
							...
							while($itera >= 0) {
								echo("<div class='large-6 columns story'><h5>Story posted by: ".$arrayOfRows[$itera]["NAME"]."</h5><p>".first50words($arrayOfRows[$itera]["TESTIMONIAL"])."<a class='readmorelink' href='story.php?storyid=".$arrayOfRows[$itera]["ID"]."'> [READ THE REST]</a></p></div>");
								$itera--;
							}
							?>
					</div>
